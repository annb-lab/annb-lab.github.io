...
Our lab is also affiliated with the <a href="http://gbb.csb.utoronto.ca/" target="_blank">Genome Biology and Bioinformatics <i class="fas fa-external-link-alt"></i></a> program and students can participate in collaborative interships with the lab. If you are a prospective graduate student, you may join the lab by applying to the <a href="https://csb.utoronto.ca/graduate-studies/prospective-students/" target="_blank">Graduate Program in Cell and Systems Biology<i class="fas fa-external-link-alt"></i></a>. Students completing their Masters degree wishing to enter the program directly into the PhD program should contact me as early as September and students entering into the Masters program (with options to transfer to the PhD program) should contact me before December to maximize potential for fellowships.<p>
Undergraduate students can join the lab for their fourth year project courses and our lab has one research position every summer. 
</p><p>
